	...
	newGame : function(gameName) {
		...
		return {
			corporations : [
				...
				{ name: 'Dipl. Ing. Frust', shares: 18, sharesAvailable: 18, ch: false, investors: {}, president: null },
				{ name: 'Fingier Presse',   shares: 16, sharesAvailable: 16, ch: false, investors: {}, president: null },
				{ name: 'Sprint & Lüngli',  shares: 14, sharesAvailable: 14, ch: false, investors: {}, president: null },
				...
				{ name: 'Jäger Bettwaren',  shares: 8,  sharesAvailable: 8,  ch: false, investors: {}, president: null },
